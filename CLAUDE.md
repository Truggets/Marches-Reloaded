...
- **Product routing (2026-09-19):** on a multi-step task, when you finish your step, send T1 the product (file path + summary under 100 words) via SendMessage and post it in #t1; T1 dispatches the next step. Do not hand work directly to another role. Small one-role tasks are exempt.
